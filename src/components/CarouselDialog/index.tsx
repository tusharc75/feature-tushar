...
const CarouselDialog = ({ images, index, close }) => {
  ...
  return (
    <Dialog maxWidth="md" fullWidth open={true} onClose={close}>
      <CustomDialogHeader title="Images" onClose={close} showRequiredLabel={false} />
      <CustomDialogContent>
        <Carousel strictIndexing animation="slide" autoPlay={false} index={index} navButtonsAlwaysVisible={images.length > 1}>
