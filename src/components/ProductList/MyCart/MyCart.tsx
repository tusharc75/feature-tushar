...
function MyCart() {
  ...
  const handleCreateQuote = (values) => {
    ...
    let selectedProducts = cloneDeep(products).filter(obj => selectedProductIds.indexOf(obj._id) >= 0)
      .map(o => {
        o.productCategory = o.productCategory?.optionValue
        o.priceTemplate = o.priceTemplate?.optionValue
        o.productTemplate = o.productTemplate?.optionValue
        return o
      })
