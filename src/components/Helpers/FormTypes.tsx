        ...
        <TextField
          ...
          onChange={
            onChange
              ? onChange
              : (e) => {
                handleChange(name, e.target.value === '' ? 0 : parseFloat(parseFloat(e.target.value)?.toFixed(fieldData?.decimalPlaces === undefined ? 2 : fieldData?.decimalPlaces)));
              }
          }
          // onChange={
          //   onChange
                    ...
                    <TextField
                      ...
                      value={
                        values[name + '_' + _currency.toLowerCase() + '_' + _unit.toLowerCase()]
                          ? values[name + '_' + _currency.toLowerCase() + '_' + _unit.toLowerCase()].toLocaleString(undefined, { maximumFractionDigits: fieldData?.decimalPlaces })
                          : values[name + '_' + _currency.toLowerCase() + '_' + _unit.toLowerCase()]
                      }
                      error={
                  ...
                  <TextField
                    ...
                    value={
                      values[name + '_' + _currency.toLowerCase()]
                        ? values[name + '_' + _currency.toLowerCase()].toLocaleString(undefined, { maximumFractionDigits: fieldData?.decimalPlaces })
                        : values[name + '_' + _currency.toLowerCase()]
                    }
