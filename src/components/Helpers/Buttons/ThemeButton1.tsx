...
const getButtonStyle = ({
  ...
  const buttonProps: ButtonProps = {
    sx: { height: '32px', gap: '5px', '& .MuiButton-icon': { margin: 0 }, ...sx }
  };
  ...
  switch (borderColor) {
    ...
    case 'yellow': {
      buttonProps.sx = { ...buttonProps.sx, border: '1px solid var(--new_theme_secondary_border_color)' };
      break;
    }
  }
  switch (textColor) {
    case 'primary': {
      buttonProps.sx = { ...buttonProps.sx, color: 'var(--primary-text)' };
      break;
    }
    case 'red': {
