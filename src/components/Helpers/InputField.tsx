                ...
                {form.sectionFields.map((field) =>
                  field.type === 'converter' || field.type === 'currencyAmount' ? (
                    ...
                    <Grid
                      ...
                      item
                      xs={12}
                      sm={field.type === 'imageUpload' || field.type === 'fileUpload' || (field.type === 'formula' && field?.fullWidth)  ? 12 : 6}
                      md={field.type === 'imageUpload' || field.type === 'fileUpload' || (field.type === 'formula' && field?.fullWidth) ? 12 : 6}
                    >
                      <FormTypes
                        {...rest}
                        {...field}
