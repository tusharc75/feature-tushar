    ...
    return type === 'singleLine' ? (
        ...
        <InfoLabel info={label} isTooltip={isTooltip}>
            <TextField
                ...
                name={name}
                value={values[name]}
                error={errors[name] === 'Email already exists' ? touched[name] || errors[name] : (touched[name] && errors[name])}
                helperText={errors[name] === 'Email already exists' ? touched[name] || errors[name] : (touched[name] && errors[name])}
                onChange={
                    onChange ? onChange : (e) => setFieldValue(name, e.target.value)
                }
            />
