export function getFilledArray<T extends (v: number, k: number) => unknown, Y extends ReturnType<T>>(range: number, mapfn: T): Y[] {
...
export function mergeArrayStringFromIndex(array: readonly string[], arrayToMerge: readonly string[], fromIndex: number): string[] {
  return array.reduce(
