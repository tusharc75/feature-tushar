...
export const RenderAvatar = memo(({ message }: { message: Message }) => {
...
export const RenderButton = memo(({ message, isUserMessage, state }: { message: Message; isUserMessage: boolean; state: UseDesktopDM }) => {
  ...
  }, [message?._id, message?.channel, socket]);
