...
const TableHead = React.memo(({ columns }: TableHeadProps) => {
  ...
  return (
    <tr>
      <th className="sticky left-0 top-0 z-10 bg-[var(--dark-primary,white)] text-sm font-semibold text-gray-500 dark:text-gray-400">
      ...
      {columns.map((col) => (
        <th
          className="sticky top-0 z-[9] min-w-[150px] border bg-[var(--dark-primary,white)] p-1 text-left text-sm font-semibold text-gray-500 "
