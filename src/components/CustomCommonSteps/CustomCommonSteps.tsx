...
const CustomCommonSteps = (props) => {
  const { disableNextStep, disablePreviousStep, steps, currentStep, setCurrentStep, onNextButtonClick, onPreviousButtonClick, forViewOnly } = props;
                ...
                <Stepper className={`${classes.pbStepper} stepper-responsive`} activeStep={activeStep}>
                  {steps.map((label, i) => (
                    <Step
                      ...
                      className={
                        forViewOnly
                          ? clsx(classes.step, classes.active, classes.currentStep)
                          : clsx(classes.step, {
                              [classes.active]: currentStep > i || steps[currentStep] === 'End',
