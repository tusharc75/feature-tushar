...
const Chatter = (props: any) => {
  ...
  return (
    <div className="overflow-hidden  shadow-lg " id="chatList">
      <div
        className="flex cursor-pointer items-center gap-3 rounded-[10px] px-[20px] py-[9px] [border:1px_solid_var(--common-border-color)]"
        onClick={(event) => handleExpandClick()}
      >
        <div className="icon-container max-w-[25px] [&_svg]:block">{<ChatBoxIcon />}</div>
