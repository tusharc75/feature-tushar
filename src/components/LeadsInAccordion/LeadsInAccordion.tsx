...
import { Box, Card, CardContent, Grid, IconButton, List, ListItem, ListItemAvatar, ListItemText, Theme, Typography } from '@mui/material';
...
export default function LeadInAccordion({ expanded = true, recordsPerLine = 3, lead }) {
        ...
        <AccordionSummary aria-controls="user-panel-content" id="user-panel-header">
          <Grid container>
            <Grid item xs={8}>
              <Box display="flex">
                <Box>
                  <IconButton size="small" onClick={() => setExpandLead(!expandLead)}>
                    {expandLead === true ? <ExpandLessIcon /> : <ExpandMoreIcon />}
                  </IconButton>
                </Box>
                <Box padding="5px">
                  <Typography variant="subtitle2">Leads (1)</Typography>
                </Box>
              </Box>
            </Grid>
          </Grid>
                              ...
                              <Grid item xs={12} sm={12} md={12}>
                                <Link className="link">
                                  <Typography className="detailName">
                                    {lead.concatedName || `${lead.firstName} ${lead.lastName}`}
