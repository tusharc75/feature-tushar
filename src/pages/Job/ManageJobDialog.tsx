                                    ...
                                    <Grid key={field.fieldName} item xs={12} sm={6} md={6}>
                                      {field.fieldName == 'customerAccount' ? (
                                        <Grid container spacing={1}>
                                          ...
                                          >
                                            <FormTypes
                                              ...
                                              type={field.type}
                                              options={accountData}
                                              disabled={!isClone ? (jobId && field.disableOnEdit) || isDisableCustomerAccount : false}
                                        ...
                                        <FormTypes
                                          ...
                                          tooltipMessage={field?.tooltipMessage}
                                          size="small"
                                          disabled={!jobId && field.disableOnEdit}
                                          onOpen={() => {
                                        ...
                                        <Box display="flex">
                                          <Box flexGrow={1}>
                                            <FormTypes
                                              {...field}
                                              disabled={Boolean(jobId) && field.disableOnEdit && !isClone}
                                              fieldData={field}
                                              values={values}
                                              errors={errors}
                                              touched={touched}
                ...
                {showAddCustomerAccountDialog && (
                  <ManageAccountDialog
                    ...
                    onGetAddedAccount={({ data }) => {
                      ...
                      if (data?.fields?.some((e) => e.fieldName === 'customerAccount')) {
