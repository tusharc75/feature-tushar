...
import { gridLoadingTimeout, prepareDataForGrid, repairType, sidebarResource } from '../../constants/helpers';
...
const RepairType = () => {
  ...
  const fetchData = async (cancelTokenSource?: CancelTokenSource) => {
    ...
    axiosInstance()
      .get(`${repairType.api}${queryString}`, { cancelToken: cancelTokenSource?.token })
    ...
    <section className="main-container-v1">
      <div className="headerbox-v1">
        ...
        <ImportExportLinks
          ...
          module={resources?.repairType?.titleSingular}
          api={repairType.api}
      ...
      <CustomContainer>
        <ListingPageHeader
          ...
          // rightSideContents
          isActionButtonVisible={permissions?.repairType?.isDelete}
          ...
          isAddButtonVisible={permissions?.repairType?.isCreate}
        />
