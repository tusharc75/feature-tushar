...
const ExpenseDetail = () => {
  ...
  const fetchFields = async () => {
    const { fieldsDataForRead } = await fetch_resource_view_fields(sidebarResource.expenses, permissions?.expenses?.isRead);
    ...
    <Box className="main-container-v1">
      ...
      <Box className={`detail-container-v1`}>
        ...
        <TabPanel value={tabValue} index={0}>
          <Box>
            {expensesData && fields ? (
              <DetailsPage data={expensesData} fields={fields} resource={sidebarResource?.expenses} referenceId={expensesData?._id} />
            ) : (
              <div className="p-2">
