...
const TruckMaster = () => {
  ...
  const fetchGridColumns = async () => {
    ...
    const newColumns = generateColumns(renderedFrom, fieldsDataForRead, routes.truckMasterDetail.path, true);
  ...
  const fetchData = async (cancelTokenSource?: CancelTokenSource) => {
    ...
    axiosInstance()
      .get(`${routes?.truckMaster.path}${queryString}`, { cancelToken: cancelTokenSource?.token })
      .then(({ data: { data } }) => {
    ...
    <section className="main-container-v1">
      ...
      <CustomContainer>
        <ListingPageHeader
          ...
          rightSideContents
          isActionButtonVisible={permissions?.truckMaster?.isDelete}
          ...
          isAddButtonVisible={permissions?.truckMaster?.isCreate}
        />
        {viewType === 1 && (
          <CardView
            data={cardViewData}
