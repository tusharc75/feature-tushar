...
const AccountsReceivable = () => {
  ...
  const fetchData = async (cancelTokenSource?: CancelTokenSource) => {
    ...
    axiosInstance()
      .get(`${routes?.accountsReceivable.path}${queryString}`, { cancelToken: cancelTokenSource?.token })
    ...
    <section className="main-container-v1">
      ...
      <CustomContainer>
        <ListingPageHeader
          ...
          // rightSideContents
          isActionButtonVisible={permissions?.accountsReceivable?.isDelete}
          ...
          isAddButtonVisible={permissions?.accountsReceivable?.isCreate}
        />
