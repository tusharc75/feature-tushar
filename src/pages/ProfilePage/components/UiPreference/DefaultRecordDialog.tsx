...
import { Box, Button, CircularProgress, TextField, Dialog, TableContainer, Paper, Table, TableHead, TableRow, TableCell, TableBody } from '@material-ui/core';
...
const DefaultRecordDialog = ({ userData, handleClose, onSuccess }) => {
    ...
    const updateData = (values) => {
        ...
        let data = { byDefaultRecord: values.data?.map((e) => { return { resource: e.resource, type: e.type } }) };
        axiosInstance()
