...
import { Box, Checkbox, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, IconButton } from '@mui/material';
      ...
      <div className="grid grid-cols-1 gap-4 rounded-md border px-2 py-2 sm:grid-cols-2 md:px-4">
        {options.map((curPreference, i) => (
          <div className="relative" key={curPreference.id}>
            <PreferenceOptions icon={curPreference.icon} heading={curPreference.heading} subtitle={curPreference.subtitle} />
