...
import { Dialog, Stepper, StepLabel, Step, Typography, makeStyles, createStyles, Theme } from '@material-ui/core';
...
const UserSetupDialog = ({
  ...
  return (
    <Dialog fullWidth maxWidth="md" open={open} onClose={close} aria-labelledby="set-approval-dialog">
