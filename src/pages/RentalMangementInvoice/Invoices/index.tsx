...
import ViewBillingDialog from 'src/pages/RentalManagement/ProgressiveBilling/ViewBillingDialog';

const Invoices = ({ rentalManagementData, rentalId }) => {

  const renderedFrom = `${camelCase(routes.rentalManagementInvoice?.title)}_invoice`
  ...
  return (
    <>
      ...
      {viewInvoiceDialog.open && (
       ...
       invoiceData={viewInvoiceDialog?.data}
       currencySymbol={rentalManagementData?.currency}
