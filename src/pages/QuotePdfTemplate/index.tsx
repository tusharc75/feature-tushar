...
import { quotePdfTemplate, isObjectEmpty, gridLoadingTimeout, quoteBuilder, prepareDataForGrid, RESOURCE_LABEL } from '../../constants/helpers';
      ...
      <CustomContainer>
        ...
        {isMobile && !isTablet ? (
          ...
          <CustomAgGrid
            ...
            showFilters={true}
            resource={RESOURCE_LABEL.quotePdfTemplate}
          />
        )}
