...
export default function NewCreateQuotePdfTemplate() {
    ...
    const typeOptions = [RESOURCE_LABEL.quoteBuilder, "Rental Job", RESOURCE_LABEL.repairJob, RESOURCE_LABEL.purchaseOrder, RESOURCE_LABEL.deliveryTicket, RESOURCE_LABEL.transferAsset].filter(d => d)
