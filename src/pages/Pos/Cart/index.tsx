          ...
          <List style={{ padding: 0 }}>
            {products?.map((product) => (
              <ListItem divider key={product._id}>
                <ListItemAvatar>
                  <Avatar src={product?.product?.productImage} alt={product?.product?.optionLabel ?? ''} />
                </ListItemAvatar>
                <ListItemText primary={product?.product?.optionLabel} secondary={`Inventory : ${product?.inventory?.availableInventory}`} />
                <Box display="flex" flexDirection="row">
                  ...
                  <IconButton
                    ...
                    size="small"
                    onClick={() => {
                      handleUpdateCart(product, 'subtract');
                    }}
                  >
