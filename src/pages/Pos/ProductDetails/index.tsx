...
const ProductDetails = () => {
  ...
  const handleUpdateCart = (product, operation) => {
    ...
    if (data?.qty) {
      ...
      setLoadingCart(true);
      axiosInstance()
        .put(`/pos/cart/remove`, { ids: [data._id] })
        .then(({ data }) => {
          fetchCart();
          setLoadingCart(false);
          ...
          <Paper>
            <div className="container">
              <Box>
                          ...
                          {isHovering && (
                            <div className={classes.zoomWrapper}>
                              <div
                                ...
                                style={{ transform: `translate(-${imageTransform.xAxis}%, -${imageTransform.yAxis}%)` }}
                              >
                          ...
                          {cartProduct ? (
                            <Box display="flex" flexDirection="row">
                              <IconButton
                                ...
                                onClick={() => {
                                  handleUpdateCart(cartProduct, 'add');
                                }}
                              >
                              ...
                              <IconButton
                                ...
                                size="small"
                                onClick={() => {
                                  handleUpdateCart(cartProduct, 'subtract');
                                }}
                              >
                ...
                <Parts product={id} warehouse={warehouseId} fetchCart={fetchCart} cart={cart} />
