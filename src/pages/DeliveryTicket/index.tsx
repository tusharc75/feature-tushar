...
import { isObjectEmpty, gridLoadingTimeout, deliveryTicket, DELIVERY_FROM_TO_TYPE, getLocalStorageArrayData, RESOURCE_LABEL } from '../../constants/helpers';
        ...
        <CustomContainer>
          ...
          {isMobile && !isTablet ? (
            ...
            <CustomAgGrid
              ...
              showFilters={true}
              resource={RESOURCE_LABEL.deliveryTicket}
            />
          ) : null}
