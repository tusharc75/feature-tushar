...
const ManageWellNumber = ({  id , onClose, onSuccess, wellMasterId }) => {
    ...
    axiosInstance()
      ...
      .then(({ data: { data } }) => {
        ...
        if (id) {
          ...
          createValues['wellName'] = wellMasterId ;
          setInitialData({
        ...
        >
          {({ values, errors, touched, submitForm, setFieldValue }) => (
            <Fragment>
              <CustomDialogHeader
                title={
                  id ? `Update ${wellNumberData?.wellNumber}` : 'Create ' + routes.wellNumber.title
                }
                onClose={() => {
                              ...
                              <Grid key={index2} item xs={12} sm={6} md={6}>
                                {field.fieldName === 'wellName' ? (
                                 ...
                                 />
                                  ...
                                  {...field}
                                  fieldData={field}
                                  disabled={Boolean(id) && field.disableOnEdit }
                                  values={values}
                                  errors={errors}
                                  touched={touched}
                                  label={field.fieldLabel}
