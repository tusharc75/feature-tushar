...
import { gridLoadingTimeout, prepareDataForGrid, sidebarResource, wellMaster } from '../../constants/helpers';
...
const WellMaster = () => {
  ...
  const fetchGridColumns = async () => {
    ...
    const newColumns = generateColumns(renderedFrom, fieldsDataForRead, routes.wellMasterDetail.path, true);
  ...
  const fetchData = async (cancelTokenSource?: CancelTokenSource) => {
    ...
    axiosInstance()
      .get(`${wellMaster.api}${queryString}`, { cancelToken: cancelTokenSource?.token })
      .then(({ data: { data, count } }) => {
        let rows = data.map((u) => {
          let finalObject = prepareDataForGrid(u, user);
          finalObject['isChecked'] = selectedRecords?.some((s) => s._id === u._id);
          finalObject['allowedToEdit'] = permissions?.wellMaster?.isUpdate;
          finalObject['canDelete'] = permissions?.wellMaster?.isDelete;
          return finalObject;
        });
