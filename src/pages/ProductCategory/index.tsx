...
import { getLocalStorageArrayData, gridLoadingTimeout, gridPageSizes, isObjectEmpty, removeLocalStorage, RESOURCE_LABEL } from '../../constants/helpers';
        ...
        {Object.keys(frameWorkComponent).length > 0 ? (
          isMobile && !isTablet ? (
            ...
            <CustomAgGrid
              ...
              showFilters={true}
              resource={RESOURCE_LABEL.productCategory}
            />
          )
        ) : null}
