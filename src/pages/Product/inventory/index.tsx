...
const NonSerializedAssetProductInventory = ({ onSuccess, onClose, productId, productInventoryData }) => {
    ...
    >
        ...
        <CustomDialogFooter>
            ...
            <CustomButton disabled={isSubmitting || isEqual(productInventoryData, inventoryData)} loading={isSubmitting} variant="contained" color="primary" type="submit" onClick={() => handleSubmit()}>
                Save
            </CustomButton>
        </CustomDialogFooter>
    </Dialog>)
