...
import { packages, gridLoadingTimeout, prepareDataForGrid, sidebarResource } from '../../constants/helpers';
...
const PackageList = () => {
  ...
  const handleDelete = () => {
    ...
    axiosInstance()
      .put(`${packages.api}/remove`, { ids: ids })
      .then(({ data }) => {
    ...
    <section className="main-container-v1">
      ...
      {showManageDialog.open && (
        <ManagePackageDialog
          ...
          packageId={showManageDialog.idToClone}
