...
import { getSectionFromUrl } from 'src/pages/UserManualNew/utilsNew';

const ManualSidebarNew = ({ state }: ComponentCommonProps) => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="flex flex-grow h-full w-[--manual-sidebar-width] flex-col pt-[var(--manual-head-height)]">
...
export default ManualSidebarNew;
