...
import { transferInventory, isObjectEmpty, gridLoadingTimeout, TRANSFER_INVENTORY_STATUS, RESOURCE_LABEL } from 'src/constants/helpers';
          ...
          Object.keys(frameWorkComponent).length > 0 ? (
            isMobile && !isTablet ? (
              ...
              <CustomAgGrid
                ...
                showFilters={true}
                resource={RESOURCE_LABEL.transferInventory}
              />
            )
          ) : null
        ) : (
