...
import { CustomDialogTransition, rentalManagement } from "./../../../constants/helpers";
        ...
        {initialData && initialData.fields.length ?
            <Formik
                ...
                {({ values,
                    ...
                    <Fragment>
                        <CustomDialogHeader title={rentalManagementId ? "Update " + routes.rentalManagement.title : "Create " + routes.rentalManagement.title} onClose={onClose}></CustomDialogHeader>
                        <CustomDialogContent>
