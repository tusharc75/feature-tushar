...
const ManageRentalManagementDialog = ({ isClone, rentalManagementId, rentalManagement = null, onClose, onSuccess, open }) => {
                ...
                <CustomDialogHeader
                    title={
                        !rentalManagementId
                            ...
                            : `${isClone ? "Clone" : `Update ${rentalManagement?.rentalJobName}`}`
                    }
                    onClose={(e, reason) => {
