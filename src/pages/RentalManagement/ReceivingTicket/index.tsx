...
const ActionButtonMenuItems = ({
  ...
  return (
    <>
      ...
      {permissions?.repairOrder?.isCreate && !isOffline && currentStep === RENTAL_STEPS.receiving && selectedRecords?.length > 0 && selectedRecords?.every(r => r?.status === ASSET_STATUS.inUse && r?.rentalAssetStatus === RENTAL_INTERNAL_ASSET_STATUS.inUse) && (
        <MenuItem
