...
const TermsAndCondition = () => {
  ...
  const fetchData = async (cancelTokenSource?: CancelTokenSource) => {
    ...
    axiosInstance()
      .get(`${termsAndCondition.api}${queryString}`, { cancelToken: cancelTokenSource?.token })
      .then(({ data: { data } }) => {
  ...
  const handleDelete = () => {
    ...
    axiosInstance()
      .put(`${termsAndCondition.api}/remove`, { ids: ids })
      .then(() => {
    ...
    <section className="main-container-v1">
      ...
      <CustomContainer>
        <ListingPageHeader
          ...
          isActionButtonVisible={permissions?.termsAndConditions?.isDelete}
      ...
      {showDeleteConfirmBox && (
        <ConfirmationDialog
          ...
          message={`Are you sure you want to delete ${resources?.termsAndConditions?.titleSingular.toLowerCase()} ${deleteRecord?.name || ''} ?`}
          onClose={() => {
            setDeleteRecord(null);
            setShowDeleteConfirmBox(false);
          }}
