...
import { Dialog, Button, Grid, TextField, TableBody, TableCell, TableHead, TableRow, TableContainer, Table, Box, Typography, CircularProgress, Paper } from '@material-ui/core';
                                            ...
                                            >
                                                ...
                                                <TableCell align="right">
                                                    <Autocomplete
                                                        ...
                                                        onChange={(event, newValue) => setKeyValue([...keyValue, { templateImportHeader: _key?.value, customImportHeader: newValue?.value }])
                                                        }
