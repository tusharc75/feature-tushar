...
import { CustomDialogTransition, demandOrder, leadTimeStatusDropdown, quotation, salesOrder } from 'src/constants/helpers';
...
function LeadTimeDialog({ salesOrderId, data, onClose, handleSucess }) {
  ...
  const handleSubmit = () => {
    ...
    axiosInstance()
      .put(`${demandOrder.api}/productpackage/${salesOrderId}/lead-time`, value)
      .then((res) => {
        setLoading(false);
        handleSucess();
