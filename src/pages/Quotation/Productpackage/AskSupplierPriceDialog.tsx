                        ...
                        <Box padding={1}>
                            <Grid container spacing={1}>
                                ...
                                <Grid item xs={12}>
                                    {from != "SupplierAskPrice" && <Autocomplete
                                        multiple
                                        options={[{ fieldName: "All", fieldLabel: "All" }, ...fields.filter(d => d.sectionName === "Supplier Information" && d.type === "currencyAmount" && (d.formula === undefined || d.formula === null || d.formula === ""))]}
                                        ...
                                        onChange={(e, val: any) => {
                                            val?.some(d => d?.fieldName === "All") ?
                                                setSelectedFields(fields?.filter(d => d.sectionName === "Supplier Information" && d.type === "currencyAmount" && (d.formula === undefined || d.formula === null || d.formula === "")).map((d) => d?.fieldName))
