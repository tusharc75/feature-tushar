...
const Productpackage = ({ quotationData, setNextStep, currencySymbol, showActivity, renderedFrom }) => {
    ...
    const handleAdd = async (rows) => {
        ...
        axiosInstance().post(`${quotation.api}/productpackage/${quotationData._id}`, { material })
            .then(() => {
    ...
    const handleSaveData = async (rows: any) => {
        ...
        setUpdating(true);
        axiosInstance().put(`${quotation.api}/productpackage/${quotationData._id}`, { material: rows }).then(() => {
            setUpdating(false)
    ...
    const handleDelete = (rows) => {
        setDeleting(true)
        axiosInstance().put(`${quotation.api}/productpackage/${quotationData?._id}/delete`, { ids: rows })
            .then(() => {
                setDeleting(false)
                fetchProductInventory()
                setDeleteData(null)
