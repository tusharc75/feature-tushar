...
import { set, startCase, uniqBy } from 'lodash';
...
const Productpackage = ({
    ...
    return (
      <>
        {quotationData?.type === QUOTATION_TYPE.rentalJob && (
          ...
          >
            {`Assign ${resources?.packages?.titlePlural}`}
          </MenuItem>
        )}
        <MenuItem
  ...
  const RightSideContents = () => {
    return (
      <ThemeButton buttonType="theme" onClick={() => setAiPriceSuggestionDialog(true)}>
    ...
    <Fragment>
      ...
      {aiPriceSuggestionDialog && (
        <AiPriceSuggestionsDialog
          setAiPriceSuggestionDialog={setAiPriceSuggestionDialog}
          aiPriceSuggestionDialog={aiPriceSuggestionDialog}
          quoteData={quotationData}
        />
      )}
      {leadTimeDialog.open && (
