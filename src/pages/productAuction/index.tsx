...
import { isObjectEmpty, gridLoadingTimeout, getLocalStorageArrayData, productAuction, removeLocalStorage, RESOURCE_LABEL } from '../../constants/helpers';
...
import { MdAdd, MdSort, MdFilterList, RiAuctionFill } from 'react-icons/all';
...
const ProductAuction = () => {
    ...
    axiosInstance()
      ...
      .then(({ data: { data, count } }) => {
        let rows = data?.map((u) => {
          ...
          finalObject['canDelete'] = permissions?.productAuction?.isUpdate;
          let res = {
            ...finalObject
          };
          return res;
  ...
  const ActionsRenderer = (params) => (
    <>
      {permissions?.productAuction?.isCreate && (
      ...
      {permissions?.productAuction?.isDelete && (
    ...
    <Fragment>
          ...
          <Grid container className={styles.filter_side_container}>
            <Grid item xs={12} md={6} sm={12} className={isMobile ? styles.mobile_panel : 'd-flex align-items-center gap-1'}>
              <div className="d-flex align-items-center">
                <RiAuctionFill size={20} style={{ paddingBottom: '3px' }} className="headerLogo" />
                <span className="listingHeader">{routes.productAuction?.title} </span>
              </div>
              {isMobile ? (
          ...
          Object.keys(frameWorkComponent).length > 0 ? (
            isMobile && !isTablet ? (
              ...
              <CustomAgGrid
                ...
                showFilters={true}
                resource={RESOURCE_LABEL.productAuction}
              />
            )
          ) : null
        ) : (
      ...
      {showManageDialog.open && (
        <ManageProductAuction
          ...
          productAuctionId={showManageDialog.idToClone}
      ...
      {showDeleteConfirmBox && (
        <ConfirmationDialog
          ...
          message={`Are you sure you want to delete the ${routes.productAuction?.title?.toLowerCase()} ${deleteRecord?.productAuction || ''} ? `}
          onClose={() => {
            setDeleteRecord(null);
            setShowDeleteConfirmBox(false);
          }}
