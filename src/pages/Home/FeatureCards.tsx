...
import WorkSpaceImage from 'src/assets/svg/home/workspace.svg';
...
const workSpaceData = {
  src: WorkSpaceImage,
  heading: routes.workSpace.title,
  description: `Workspace is a collaborative platform that boosts team efficiency with integrated tools for communication.`,
  href: routes.workSpace.path,
  buttonText: 'Get into the world '
};
...
const FeatureCard = () => {
  ...
  const workspacePermission = permissions?.workSpace;
