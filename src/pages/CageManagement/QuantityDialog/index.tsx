...
import { Avatar, Button, Dialog, List, ListItem, ListItemAvatar, ListItemText, TextField } from '@material-ui/core';
            ...
            <CustomDialogContent>
              <List style={{ padding: 0 }}>
                <ListItem divider key={product?._id}>
                  ...
                  <ListItemText primary={product?.productName} secondary={`Inventory : ${product?.availableInventory}`} />
