...
import { isObjectEmpty, customerAccount, supplierAccount, gridLoadingTimeout, serviceOrder, prepareDataForGrid, getLocalStorageArrayData, removeLocalStorage } from '../../constants/helpers';
                        ...
                        <Grid item xs={12} sm={12}>
                            <Grid container justify="flex-end">
                                <ImportExportLinks
                                    ...
                                    afterImportCompleted={() => { fetchServiceOrders() }}
            ...
            <CustomContainer>
                    ...
                    Object.keys(frameworkComponents).length > 0 ?
                        isMobile && !isTablet ?
                            <CustomSwipableList
                                ...
                                onCreate={false}
                                showClone={true}
                                onClone={(data) => { setShowManageServiceOrderDialog({ open: true, isClone: true, idToClone: data._id }); }}
                ...
                {isConfirmDialogVisible ? (
                    <ConfirmationDialog
                        ...
                        message={`Are you sure you want to delete ${deleteRecord?.serviceOrderNumber ? 'Service Order' : 'Service Orders'}   ${deleteRecord.serviceOrderNumber || ''
                            }?`}
                        onClose={() => {
                            if (deleteRecord) setDeleteRecord({});
                            setIsConformDialogVisible(false);
