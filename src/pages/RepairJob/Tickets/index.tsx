...
const renderedFrom = 'repairJob_tickets';
...
const Tickets = ({ repairJobData }) => {
    ...
    const fetchRecords = async () => {
        ...
        let data;
        const response = await axiosInstance().get(`${deliveryTicket.api}/typewise?refrenceType=${DELIVERY_TICKET_REFRENCE_TYPE.repairJob}&refrenceId=${repairJobData._id}`)
