...
const ContactUs = () => {
  ...
  const ActionsRenderer = {
    ...
    Cell: ({ row }) => (
      <>
        {permissions?.contactUs?.isCreate ? (
        ...
        {permissions?.contactUs?.isDelete && (
  ...
  const fetchData = async (cancelTokenSource?: CancelTokenSource) => {
    ...
    axiosInstance()
      .get(`${routes?.contactUs.path}${queryString}`, { cancelToken: cancelTokenSource?.token })
      .then(({ data: { data } }) => {
  ...
  const handleDelete = () => {
    ...
    axiosInstance()
      .put(`${routes?.contactUs.path}/remove`, { ids: ids })
      .then(() => {
    ...
    <section className="main-container-v1">
      ...
      <CustomContainer>
        <ListingPageHeader
          ...
          // rightSideContents
          isActionButtonVisible={permissions?.contactUs?.isDelete}
          ...
          isAddButtonVisible={permissions?.contactUs?.isCreate}
        />
