    ...
    <Layout>
      <div className={classes.root}>
        ...
        <Container>
          ...
          <TabPanel value={value} index={0} style={{ marginBottom: 20 }}>
            <OpportunityInformation />
          </TabPanel>
          <TabPanel value={value} index={1} style={{ marginBottom: 20 }}>
            <Contacts />
          </TabPanel>
          <TabPanel value={value} index={2} style={{ marginBottom: 20 }}>
            <OpportunityInformation />
          </TabPanel>
          <TabPanel value={value} index={3} style={{ marginBottom: 20 }}>
            <OpportunityInformation />
          </TabPanel>
          <TabPanel value={value} index={4} style={{ marginBottom: 20 }}>
            <OpportunityInformation />
          </TabPanel>
          <TabPanel value={value} index={5} style={{ marginBottom: 20 }}>
            <OpportunityInformation />
          </TabPanel>
          <TabPanel value={value} index={6} style={{ marginBottom: 20 }}>
            <OpportunityInformation />
          </TabPanel>
        </Container>
      </div>
