...
import { opportunity, isObjectEmpty, customerAccount, supplierAccount, gridLoadingTimeout, RESOURCE_LABEL } from '../../constants/helpers';
          ...
          Object.keys(frameWorkComponent).length > 0 ?
            isMobile && !isTablet ?
              ...
              <CustomAgGrid
                ...
                showFilters={true}
                resource={RESOURCE_LABEL.opportunity}
              /> : null
        }
