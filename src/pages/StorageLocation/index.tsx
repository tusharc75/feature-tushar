...
const StorageLocation = () => {
    ...
    const fetchData = () => {
        ...
        axiosInstance().get(`${storageLocation.api}${queryString}`).then(({ data: { data } }) => {
    ...
    const handleDelete = () => {
        ...
        axiosInstance().put(`${storageLocation.api}/remove`, { "ids": ids }).then(() => {
            fetchData();
    ...
    return (<Fragment>
                ...
                <Grid container className={styles.filter_side_container}>
                    <Grid item xs={12} md={6} sm={12} className={isMobile ? styles.mobile_panel : "d-flex align-items-center gap-1"}>
                        <div className="d-flex align-items-center">
                            ...
                            <span className="listingHeader">{routes.storageLocation?.title} </span>
                        </div>
                        {isMobile ? (
        ...
        {showDeleteConfirmBox &&
            <ConfirmationDialog
                ...
                message={`Are you sure you want to delete the ${routes.storageLocation?.title?.toLowerCase()} ${deleteRecord?.storageLocation || ""} ? `}
                onClose={() => {
                    setDeleteRecord(null);
                    setShowDeleteConfirmBox(false)
                }}
