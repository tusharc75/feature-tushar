  ...
  return (
    <div className={cn('relative mt-3 flex h-[calc(100vh-200px)] gap-4 overflow-hidden')}>
      <div className={cn('transition-all duration-300', view === 'map' ? 'md:w-[300px]' : 'w-full flex-grow')}>
        <CardView resource={resource} data={data} clickOnCard={onClick} view={view} />
      </div>
      {view === 'map' && (
        <div
          className={cn(
            `overflow-hidden rounded-md transition-all duration-300 
            [&_.gm-style-iw-tc:after]:bg-[var(--dark-primary,white)] [&_.gm-style-iw.gm-style-iw-c]:bg-[var(--dark-primary,white)] 
             [&_button.gm-ui-hover-effect]:!-mr-3 [&_button.gm-ui-hover-effect]:!size-[24px]
            [&_button.gm-ui-hover-effect_span]:!m-0
