  ...
  const fetchGridColumns = () => {
    axiosInstance()
      ...
      .then(({ data: { data } }) => {
        ...
        let rendererNames = [];
        data.forEach((o) => {
          let currentColumn = getColumnData(renderedFrom, o?.fieldData, routes.padMasterDetail.path);
    ...
    <Fragment>
      <Grid container className="headerbox">
        <Grid item md={4} sm={11} xs={10}>
          <CustomBreadCrumbs routes={[{ title: routes.padMaster.title }]} />
        </Grid>
