                            ...
                            <Grid container spacing={1} className={styles.full_layout}>
                                {sections.map((section) => {
                                    return section.items.length > 0 ? (
                                        <Grid key={section.head} item xs={12} sm={4} md={4}
                                              className={styles.all_box_layout}>
                                                ...
                                                <Paper className={styles.back_box}>
                                                    ...
                                                    <Grid >
                                                        {<Box height="215px" style={{overflowY: 'auto'}}
                                                              className={styles.back_box_content}>
                                                            {section.items.map((item) => (
                                                                <div key={item.name}>
                                                                    <Box marginY={1} component="div" className={styles.list_component}>
                                                                        <Typography paragraph
                                                                                    className={styles.hover_list_box}>
                                                                            <Link
                                                                                to={handleRoutes(item)}>{item.resourceLabel || item.name}</Link>
                                                                        </Typography>
                                                                    </Box>
