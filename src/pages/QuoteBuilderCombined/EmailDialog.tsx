...
import { CustomDialogTransition, imageUploadMaxSize } from "./../../constants/helpers";
...
const EmailDialog = (props) => {
    ...
    const { handleClose, success, id, version, account, emailId } = props;
    const [loading, setLoading] = useState(false);
    const [initialData, setInitialData] = useState({ subject: "", body: RichTextEditor.createEmptyValue(), cc: "", to: "", account: "", contact: "" });
                            ...
                            <Form autoComplete="off" autoCorrect="off" noValidate >
                                ...
                                <Box p={1}>
                                    <TextField
                                        ...
                                        onChange={(e) => setFieldValue("to", e.target.value.trimStart())}
                                    />
                                </Box>
