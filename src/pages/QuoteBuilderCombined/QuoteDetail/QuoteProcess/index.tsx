  ...
  return (
    <>
      <Paper className={classes.bgProduct}>
        <Grid container className="detailHeader d-flex align-items-center form-label-style mt-0 mb-0">
          {ProcessStatus === 'New' ? null : (
            <Grid item xs={12} sm={7} md={7} className="quoteHeader">
          ...
          >
            ...
            {allowedToEdit && ifQuoteApproved.approved ? (
              <Button variant="outlined" color="primary" size="small" startIcon={<HiPencil />} onClick={handleOpenUpdateDialog}>
                Edit Information
              </Button>
            ) : null}
            <div>
            ...
            </div>
            {
              <>
                ...
                <Button
                  ...
                  type="button"
                  size="small"
                  startIcon={isCloning ? <CircularProgress color="inherit" size={16} /> : <BiLayerPlus />}
                  className="mx-1"
                  color="primary"
                  onClick={() => {
                    cloneVersion();
                ...
                >
                  {isCloning ? <>Cloning v{currentVersion}</> : `Clone ${currentVersion}`}
                </Button>{' '}
              </>
            }
          </Grid>
            ...
            {ProcessStatus !== 'New' && ProcessStatus !== 'Price Builder' ? (
              <span className="d-flex align-items-center justify-content-end mt-3 ml-3">
                ...
                {permissions[qbResource]?.isUpdate &&
                  permissions?.quotePdfTemplate.isUpdate &&
