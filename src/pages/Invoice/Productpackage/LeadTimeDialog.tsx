...
import { CustomDialogTransition, leadTimeStatusDropdown, quotation, invoice } from 'src/constants/helpers';
...
function LeadTimeDialog({ invoiceId, data, onClose, handleSucess }) {
  ...
  const handleSubmit = () => {
    ...
    axiosInstance()
      .put(`${invoice.api}/productpackage/${invoiceId}/lead-time`, value)
      .then((res) => {
        setLoading(false);
        handleSucess();
