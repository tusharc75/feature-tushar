...
const Zone = () => {
  ...
  const fetchData = async (cancelTokenSource?: CancelTokenSource) => {
    ...
    axiosInstance()
      .get(`${routes.zone.path}${queryString}`, { cancelToken: cancelTokenSource?.token })
    ...
    <section className="main-container-v1">
      ...
      <CustomContainer>
        <ListingPageHeader
          ...
          // rightSideContents
          isActionButtonVisible={permissions?.zone?.isDelete}
          ...
          isAddButtonVisible={permissions?.zone?.isCreate}
        />
