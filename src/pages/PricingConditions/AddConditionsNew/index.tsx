...
const AddConditions = ({ pricingConditionId, detailData }) => {
  ...
  const fetchCondition = () => {
    ...
    setCondition(null);
    axiosInstance()
      .get(`${pricingCondition.api}/${pricingConditionId}/condition`)
      .then(({ data: { data } }) => {
  ...
  const handleAdd = (rows) => {
    ...
    axiosInstance()
      .post(`${pricingCondition.api}/${pricingConditionId}/condition`, { condition: data })
      .then(({ data: { data } }) => {
  ...
  const handleDelete = (ids) => {
    axiosInstance()
      .post(`${pricingCondition.api}/${pricingConditionId}/condition/remove`, { ids })
      .then(() => {
        fetchCondition();
      })
      .catch((error) => {
