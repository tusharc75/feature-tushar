...
const ManageContentPostPlanning = ({
    open,
    isEdit = false,
    idToEdit = null,
    onClose,
    onSuccess
}: ManageContentPostPlanningProps) => {
    ...
    const fetchFields = async () => {
        try {
            const { fieldsDataForCreate, fieldsDataForUpdate, fieldsDataAll } =
                await fetch_resource_fields(sidebarResource.contentPostPlanning);
