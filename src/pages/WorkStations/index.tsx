...
const WorkStations = () => {
  ...
  const fetchGridColumns = () => {
    axiosInstance()
      ...
      .then(({ data: { data } }) => {
        ...
        let rendererNames = [];
        data.forEach((o) => {
          let currentColumn = getColumnData(renderedFrom, o?.fieldData, routes.workStationsDetail.path, true);
    ...
    axiosInstance()
      ...
      .then(({ data: { data } }) => {
        ...
        let rows = data?.data?.map((u: any) => {
          ...
          finalObject['canDelete'] = permissions?.workStations?.isDelete;
          finalObject['isChecked'] = selectedRecords?.some((s) => s._id === u._id);
          finalObject['allowedToEdit'] = permissions?.workStations?.isUpdate;
  ...
  const ActionsRenderer = (params) => (
    <Fragment>
      {permissions?.workStations?.isCreate ? (
        <Tooltip title="Clone">
          <IconButton
            aria-label="Clone"
            onClick={() => {
              setWorkStationId(params.data.id);
  ...
  const handleDelete = () => {
    ...
    axiosInstance()
      .put(`${routes?.workStations?.path}/remove`, { ids: ids })
      .then(({ data }) => {
        removeLocalStorage(localStorageSelectedRecords);
        fetchWorkStationsData();
  ...
  return (
    <section className="main-container-v1">
      <div className="headerbox-v1">
        <CustomBreadCrumbs routes={[{ title: routes.workStations.title }]} />
        <ImportExportLinks
      ...
      <CustomContainer>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div className="flex flex-wrap gap-[8px]  justify-end">
              ...
              <div className="flex gap-[8px] flex-wrap items-center">
                ...
                {permissions?.workStations?.isDelete && (
                  <>
                    <Button
                      variant={'outlined'}
                      color="default"
        ...
        {Object.keys(frameWorkComponent).length > 0 ? (
          isMobile && !isTablet ? (
            ...
            <CustomAgGrid
              ...
              loading={loading}
              renderedFrom={renderedFrom}
              refreshGrid={fetchWorkStationsData}
        ...
        {showDeleteConfirmBox && (
          <ConfirmationDialog
            ...
            message={`Are you sure you want to delete ${routes?.workStations?.title?.toLowerCase()}  ${deleteRecord?.workStationName || ''} ?`}
            onClose={() => {
              setDeleteRecord(null);
              setShowDeleteConfirmBox(false);
            }}
