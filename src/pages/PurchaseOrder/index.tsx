    ...
    <section className="main-container-v1">
      ...
      {showDeleteConfirmBox && (
        <ConfirmationDialog
          ...
          message={`Are you sure you want to delete the ${deleteRecord ? `${resources?.purchaseOrder?.titleSingular?.toLowerCase()} : ${deleteRecord?.purchaseOrderNumber}` : `${resources?.purchaseOrder?.titleSingular?.toLowerCase()}(s)`} ?`}
          onClose={() => {
            setDeleteRecord(null);
            setShowDeleteConfirmBox(false);
          }}
