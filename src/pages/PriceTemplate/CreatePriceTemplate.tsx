  ...
  const onBackButtonEvent = (e) => {
    if (hasPermissionToUpdate) {
      ...
      if (!isEqual(ref.current.values, initialValues) || !isEqual(initialValues.section, section)) {
        if ((id === '0' && priceTemplatePermissions.isCreate) || (id !== '0' && priceTemplatePermissions.isUpdate)) {
    ...
    <Fragment>
      ...
      <Box className="main-container-v1">
          ...
          <Box className="controls-v1">
            <Box className="control-buttons-v1">
              <div className={classes.linksContainer}>
                ...
                <label onClick={handleExportFields} className={`new-headerbox-button-v1`}>
                  Export Fields
                </label>
        ...
        <Box className={`detail-container-v1`}>
          {initialValues ? (
            <Formik innerRef={ref} initialValues={initialValues} validationSchema={PriceTemplateSchema} onSubmit={handleSave}>
