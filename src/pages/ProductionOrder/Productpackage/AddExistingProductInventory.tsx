...
import { gridLoadingTimeout, CustomDialogTransition, packages, isObjectEmpty, prepareDataForGrid, getLocalStorageArrayData, product } from '../../../constants/helpers';
...
const AddExistingProductInventory = ({ addProductInventory, handleProductInventoryClose, type, isAddingProducts, productionOrderData, renderedFrom }) => {
