...
export function extractSentenceWithValue(inputValue: string, htmlContent: string): string | null {
...
function renderRow(props: ListChildComponentProps) {
  ...
  if (dataSet.hasOwnProperty('group')) {
    return (
      <ListSubheader
        key={dataSet.key}
        className="line-clamp-1 !bg-[white] text-[14px] font-medium text-[#828282] dark:!bg-[rgb(36,37,38)] dark:text-[#9c9b9e] [&:not(:first-child)]:border-t"
        component="div"
        style={inlineStyle}
      >
        {dataSet.group}
...
export const ListboxComponent = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLElement>>(function ListboxComponent(props, ref) {
  ...
  return (
    <div ref={ref} className="[&>div]:!bg-[white] dark:[&>div]:!bg-[rgb(36,37,38)]">
