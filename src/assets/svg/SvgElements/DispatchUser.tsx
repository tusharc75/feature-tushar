...
const DispatchUser = ({ size = 18, ...rest }: SvgPropsWithSize) => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={size} height={size} fill="none" viewBox="0 0 512 512" {...rest}>
      ...
      <path
        fill="currentcolor"
        d="M438.967 217.953c-6.654-6.653-17.442-6.653-24.096 0-6.653 6.654-6.653 17.442 0 24.095l23.699 23.706h-76.653c-8.975 0-16.25 7.275-16.25 16.249 0 8.975 7.275 16.25 16.25 16.25h76.653l-23.699 23.699c-6.653 6.653-6.653 17.441 0 24.095 6.654 6.653 17.442 6.653 24.096 0l61.749-61.749a3.25 3.25 0 0 0 0-4.596z"
      ></path>
    </svg>
  );
};
